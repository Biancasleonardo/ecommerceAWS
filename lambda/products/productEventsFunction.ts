...
// o retorno da função é feito através do callback
...
function creatEvent(event: ProductEvent) {
    const timestamp = Date.now()
    const ttl = ~~(timestamp / 1000 + 5 * 60) //timestamp + 5 minutos
